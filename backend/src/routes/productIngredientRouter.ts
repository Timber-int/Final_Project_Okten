...
import {
    authMiddleware, dataValidatorMiddleware, fileMiddleware, productIngredientMiddleware,
} from '../middlewares';
...
router.post('/', (req: IRequestExtended, res: Response, next: NextFunction) => {
    ...
    next();
}, authMiddleware.checkIsUserHasLawAdministrator, dataValidatorMiddleware.dataValidator, productIngredientMiddleware.checkIsProductIngredientExist, fileMiddleware.checkIsProductPhotoFileExist, productIngredientController.createProductIngredient,
);
...
router.put('/:id', (req: IRequestExtended, res: Response, next: NextFunction) => {
    ...
    next();
}, authMiddleware.checkIsUserHasLawAdministrator, dataValidatorMiddleware.dataValidator, productIngredientMiddleware.checkIsProductIngredientExist, fileMiddleware.checkIsProductPhotoToUpdateFileExist, productIngredientController.updateProductIngredientById,
